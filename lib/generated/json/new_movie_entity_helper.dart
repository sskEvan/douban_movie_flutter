...
newMovieEntityFromJson(NewMovieEntity data, Map<String, dynamic> json) {
	if (json['subjects'] != null) {
		data.subjects = new List<NewMovieSubject>();
		(json['subjects'] as List).forEach((v) {
			data.subjects.add(new NewMovieSubject().fromJson(v));
		});
	}
	if (json['title'] != null) {
...
newMovieSubjectFromJson(NewMovieSubject data, Map<String, dynamic> json) {
	if (json['rating'] != null) {
		data.rating = new NewMovieSubjectsRating().fromJson(json['rating']);
	}
	if (json['genres'] != null) {
	...
	if (json['casts'] != null) {
		data.casts = new List<NewMovieSubjectsCast>();
		(json['casts'] as List).forEach((v) {
			data.casts.add(new NewMovieSubjectsCast().fromJson(v));
		});
	}
	...
	if (json['directors'] != null) {
		data.directors = new List<NewMovieSubjectsDirector>();
		(json['directors'] as List).forEach((v) {
			data.directors.add(new NewMovieSubjectsDirector().fromJson(v));
		});
	}
	...
	if (json['images'] != null) {
		data.images = new NewMovieSubjectsImages().fromJson(json['images']);
	}
	if (json['alt'] != null) {
...
Map<String, dynamic> newMovieSubjectToJson(NewMovieSubject entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
newMovieSubjectsRatingFromJson(NewMovieSubjectsRating data, Map<String, dynamic> json) {
	if (json['max'] != null) {
	...
	if (json['details'] != null) {
		data.details = new NewMovieSubjectsRatingDetails().fromJson(json['details']);
	}
	if (json['stars'] != null) {
...
Map<String, dynamic> newMovieSubjectsRatingToJson(NewMovieSubjectsRating entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['max'] = entity.max;
...
newMovieSubjectsRatingDetailsFromJson(NewMovieSubjectsRatingDetails data, Map<String, dynamic> json) {
	if (json['i1'] != null) {
...
Map<String, dynamic> newMovieSubjectsRatingDetailsToJson(NewMovieSubjectsRatingDetails entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['i1'] = entity.i1;
	data['i3'] = entity.i3;
	data['i2'] = entity.i2;
...
newMovieSubjectsCastFromJson(NewMovieSubjectsCast data, Map<String, dynamic> json) {
	if (json['avatars'] != null) {
		data.avatars = new NewMovieSubjectsCastsAvatars().fromJson(json['avatars']);
	}
...
Map<String, dynamic> newMovieSubjectsCastToJson(NewMovieSubjectsCast entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
newMovieSubjectsCastsAvatarsFromJson(NewMovieSubjectsCastsAvatars data, Map<String, dynamic> json) {
	if (json['small'] != null) {
...
Map<String, dynamic> newMovieSubjectsCastsAvatarsToJson(NewMovieSubjectsCastsAvatars entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
newMovieSubjectsDirectorFromJson(NewMovieSubjectsDirector data, Map<String, dynamic> json) {
	if (json['avatars'] != null) {
		data.avatars = new NewMovieSubjectsDirectorsAvatars().fromJson(json['avatars']);
	}
	if (json['name_en'] != null) {
		data.nameEn = json['name_en']?.toString();
	}
...
Map<String, dynamic> newMovieSubjectsDirectorToJson(NewMovieSubjectsDirector entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	if (entity.avatars != null) {
		data['avatars'] = entity.avatars.toJson();
	}
...
newMovieSubjectsDirectorsAvatarsFromJson(NewMovieSubjectsDirectorsAvatars data, Map<String, dynamic> json) {
	if (json['small'] != null) {
		data.small = json['small']?.toString();
	}
	if (json['large'] != null) {
...
Map<String, dynamic> newMovieSubjectsDirectorsAvatarsToJson(NewMovieSubjectsDirectorsAvatars entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['small'] = entity.small;
	data['large'] = entity.large;
	data['medium'] = entity.medium;
...
newMovieSubjectsImagesFromJson(NewMovieSubjectsImages data, Map<String, dynamic> json) {
	if (json['small'] != null) {
		data.small = json['small']?.toString();
	}
	if (json['large'] != null) {
...
Map<String, dynamic> newMovieSubjectsImagesToJson(NewMovieSubjectsImages entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['small'] = entity.small;
	data['large'] = entity.large;
	data['medium'] = entity.medium;
