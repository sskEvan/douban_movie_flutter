...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case WeeklyMovieEntity:
			...
			return weeklyMovieSubjectFromJson(data as WeeklyMovieSubject, json) as T;			case MovieSubject:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case WeeklyMovieEntity:
			...
			return weeklyMovieSubjectToJson(data as WeeklyMovieSubject);			case MovieSubject:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'WeeklyMovieEntity':
			...
			return WeeklyMovieSubject().fromJson(json);			case 'MovieSubject':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'WeeklyMovieEntity':
			...
			return List<WeeklyMovieSubject>();			case 'MovieSubject':
